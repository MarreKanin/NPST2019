...
with open('keys.txt', 'r') as keys:
    for line in keys:
        line = line.replace('\n', '')
        if line not in keychain:
            keychain.append(line)
counter = 0
for key in keychain:
    ...
    counter += 1
    if 'PST{' in output_str:
        print(key, output_str)
